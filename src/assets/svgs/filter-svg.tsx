...
export default function FilterSvg(props: React.SVGProps<SVGSVGElement>) {
    return (
        ...
        >
            ...
            <path d="M57.1577 17L28.5789 33.5L52.3946 33.75L63.6529 40.25L70.1481 36.5L58.8897 30L57.1577 17Z" className="fill-muted stroke-neutral-600 dark:stroke-neutral-400" />
        </svg>
    );
}