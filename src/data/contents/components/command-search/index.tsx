...
export const CommandSearch: FC<Props> = ({
    ...
    useEffect(() => {
        ...
        return () => window.removeEventListener('keydown', handleEscape as any, true);
    }, [onClose]);
        ...
        >
            ...
            >
                ...
                <div className="flex items-center px-4 py-3.5 border-b-[1.4px] border-zinc-100 dark:border-zinc-800/50">
                    <Search size={18} className="text-zinc-400 dark:text-zinc-500 mr-3" strokeWidth={2.5} />
                    <input
                        ref={inputRef}
                        type="text"
                        placeholder="Find..."
                    ...
                    <div className="flex items-center gap-1.5 ml-2">
                        <span className="text-[11px] font-bold text-zinc-400 dark:text-zinc-500 border border-zinc-200 dark:border-zinc-800 p-0.5 px-1 rounded-[2px] bg-zinc-50 dark:bg-zinc-900/50">Esc</span>
                    </div>
                </div>
                          ...
                          `}
                                                ...
                                                >
                                                    <div className="flex items-center gap-3">
                                                        <span className={`${isActive ? 'text-zinc-900 dark:text-white' : 'text-zinc-400 dark:text-zinc-500 group-hover:text-zinc-600 dark:group-hover:text-zinc-300'}`}>
                                                            {item.icon}
                                                        </span>
