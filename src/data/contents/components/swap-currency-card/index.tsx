  ...
  return (
    <div className="relative flex w-full items-center justify-center bg-transparent transition-colors duration-500 px-4 py-6">
      <motion.div
        ...
        className="w-full max-w-sm border-[1.6px] border-[#E5E5E9] dark:border-zinc-800 bg-[#FEFEFE] dark:bg-zinc-900 rounded-[32px] sm:rounded-[40px] p-6 sm:p-8 shadow-[0_32px_47px_-16px_rgba(0,0,0,0.1)] dark:shadow-[0_32px_60px_-16px_rgba(0,0,0,0.5)] flex flex-col gap-5 sm:gap-6"
      >
        ...
        <div className="flex flex-col gap-1.5 sm:gap-2">
          {/* Input */}
          <div className="flex items-center justify-between p-3.5 sm:p-4 bg-[#F6F5FA] dark:bg-zinc-800/50 rounded-t-4xl sm:rounded-t-[24px] rounded-b-2xl sm:rounded-b-3xl">
          ...
          {/* Input Block 2 */}
          <div className="flex items-center justify-between p-3.5 sm:p-4 bg-[#F6F5FA] dark:bg-zinc-800/50 rounded-b-4xl sm:rounded-b-[24px] rounded-t-2xl sm:rounded-t-3xl">
            <div className="relative flex-1 mr-2">
