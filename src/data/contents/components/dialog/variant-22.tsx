...
const Dialog22 = () => {
  return (
    <Dialog>
      ...
      <DialogContent className="top-auto bottom-0 mb-6 translate-y-0 sm:max-w-[425px] bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-8 shadow-xl">
        <DialogHeader>
