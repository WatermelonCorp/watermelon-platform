...
const Dialog16 = () => {
  return (
    <Dialog>
      ...
      <DialogContent className="sm:top-0 sm:left-0 sm:m-6 sm:max-w-[425px] sm:translate-x-0 sm:translate-y-0 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-8 shadow-xl">
        <DialogHeader>
