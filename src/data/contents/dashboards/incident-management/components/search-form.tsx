      ...
      <SidebarGroup className="pb-1 pt-2 pl-4 pr-2">
        <SidebarGroupContent className="relative">
          ...
          <SidebarInput
            id="search"
            placeholder="Search"
            className="pl-8 bg-neutral-100/50 dark:bg-neutral-900! border-neutral-200 dark:border-neutral-800 text-neutral-900 dark:text-neutral-100 placeholder:text-neutral-400 dark:placeholder:text-neutral-500 h-9 rounded-lg focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-neutral-400 dark:focus-visible:border-neutral-600 outline-none shadow-none"
          />
