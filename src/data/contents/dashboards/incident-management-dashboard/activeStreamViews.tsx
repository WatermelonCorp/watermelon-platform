            ...
            <Tabs defaultValue="flowView" className="flex-1 flex flex-col min-h-0">
                ...
                <TabsContent value="flowView" className="flex-1 flex flex-col p-6 pt-3 bg-white dark:bg-neutral-950 overflow-hidden gap-7 min-h-0">
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                        <Button variant="outline" className="bg-neutral-200/50 dark:bg-neutral-900/50 hover:bg-[#f2f2f2] dark:hover:bg-neutral-800 border-neutral-100/50 dark:border-neutral-800/50 rounded-lg px-3 flex items-center gap-3 font-medium text-neutral-800 dark:text-neutral-200 shadow-none transition-colors">
                            Filter
                        ...
                        {[
                            { label: "Assigned unit", value: "unit" },
                            { label: "Service type", value: "service" },
                            { label: "Resolution window", value: "resolution" },
                            { label: "Impact", value: "impact" },
                        ].map((filter) => (
                            <Select key={filter.value}>
                                <SelectTrigger className="w-fit bg-white dark:bg-neutral-900 border-neutral-200 dark:border-neutral-800 rounded-lg pl-3 pr-2 font-medium text-neutral-400 dark:text-neutral-500 hover:bg-neutral-50 dark:hover:bg-neutral-800 shadow-none transition-all text-sm">
