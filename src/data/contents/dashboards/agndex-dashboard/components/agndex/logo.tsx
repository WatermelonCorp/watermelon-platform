...
export const AgndexLogo = ({ className, ...props }: SVGProps<SVGSVGElement>) => (
  <svg
    width={24}
    height={24}
    viewBox="0 0 200 200"
    ...
    {...props}
  >
    <g clipPath="url(#clip0_agndex_logo)">
      <path
        ...
        fill="url(#paint0_agndex_logo)"
      />
    </g>
    <defs>
      <radialGradient
        id="paint0_agndex_logo"
        cx="100"
        cy="100"
        r="120"
      ...
      >
        ...
        <stop offset="1" stopColor="color-mix(in oklab, var(--primary) 70%, white)" />
      </radialGradient>
      <clipPath id="clip0_agndex_logo">
