    ...
    >
      ...
      <SidebarContent className="mt-6 px-2.75 group-data-[collapsible=icon]:overflow-x-hidden! group-data-[collapsible=icon]:overflow-y-auto!">
        {[
          ...
          <SidebarGroup key={group.label}>
            <SidebarGroupLabel className='text-sm mb-3'>{group.label}</SidebarGroupLabel>
            <SidebarGroupContent>
      ...
      <SidebarFooter className='p-0'>
        <div className='p-3 group-data-[collapsible=icon]:p-2.5!'>
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className='w-full flex items-center gap-2 text-left border-none outline-none group-data-[collapsible=icon]:size-12! group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:gap-0'>
