  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          "group/sidebar-wrapper has-data-[variant=inset]:bg-gray-100 dark:has-data-[variant=inset]:bg-neutral-900 flex min-h-svh w-full",
          className,
        )}
        {...props}
      >
    ...
    >
      ...
      >
        <div
          ...
          className="bg-sidebar group-data-[variant=floating]:ring-sidebar-border group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:ring-1 flex size-full flex-col"
        >
          {children}
        </div>
      </div>
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn(className, "cursor-pointer shrink-0")}
      onClick={(event) => {
        onClick?.(event);
        toggleSidebar();
      }}
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "bg-gray-100 dark:bg-neutral-900 md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2 relative flex w-full flex-1 flex-col",
        className,
      )}
      {...props}
    />
...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn("p-2relative flex w-full min-w-0 flex-col", className)}
      {...props}
    />
  );
}
