              ...
              return (
                <a
                  ...
                  className={cn(
                    ...
                    subActive &&
                      'bg-card text-primary hover:bg-card hover:text-primary border font-semibold shadow-xs',
                  )}
                >
