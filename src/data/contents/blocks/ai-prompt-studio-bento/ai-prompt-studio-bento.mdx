---
title: AI Prompt Studio Bento
slug: ai-prompt-studio-bento
category: bento
description: >-
...
image: 'https://assets.watermelon.sh/components/watermelonoriginalassets/ai-prompt-studio-bento.webp'
video: 'https://assets.watermelon.sh/components/watermelonoriginalassets/ai-prompt-studio-bento.mp4'
featured: false
comingSoon: false
dependencies:
  - motion/react
install:
  - 'npx shadcn@latest add https://registry.watermelon.sh/r/ai-prompt-studio-bento.json'
componentNumber: 1
---
