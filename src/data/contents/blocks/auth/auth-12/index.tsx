...
export default function Auth12() {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-white font-sans text-slate-900 antialiased selection:bg-[#87B027]/20 selection:text-[#87B027] lg:flex-row">
      {/* Left Image Panel */}
          ...
          <form className="flex flex-col gap-5">
            ...
            <motion.div variants={itemVariants} className="flex flex-col gap-2">
              ...
              <input
                ...
                className="w-full rounded-md border border-slate-200 bg-white px-4 py-3 text-[14px] text-slate-900 placeholder:text-slate-400 focus:border-[#87B027] focus:outline-none focus:ring-1 focus:ring-[#87B027] transition-colors"
              />
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="flex flex-col gap-2">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-md border border-slate-200 bg-white px-4 py-3 pr-10 text-[14px] font-mono text-slate-900 placeholder:text-slate-400 focus:border-[#87B027] focus:outline-none focus:ring-1 focus:ring-[#87B027] transition-colors"
                />
                <button
                  type="button"
            ...
            <motion.div variants={itemVariants} className="flex items-center justify-between mt-1">
              <div className="flex items-center gap-2.5">
                <input
                  id="remember"
                  type="checkbox"
                  className="size-[18px] rounded border-slate-300 text-[#87B027] focus:ring-[#87B027] transition-colors"
                />
            ...
            <motion.div variants={itemVariants} className="mt-2">
              <button
                type="submit"
                className="w-full rounded-md bg-[#87B027] py-3 text-[14px] font-medium text-white transition-transform active:scale-[0.98] hover:bg-[#729620]"
              >
                Sign in
              </button>
            </motion.div>
