      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold tracking-tight text-neutral-900 lg:hidden dark:text-white">Watermelon</span>
          </div>
            ...
            <NavigationMenuList className="gap-6">
              ...
              <NavigationMenuItem className="gap-5">
                ...
                <NavigationMenuContent className="!w-full">
                  <div className="mx-auto grid max-w-6xl grid-cols-4 gap-6 px-6 py-8 divide-x">
                    {/* Column 1 */}
                    <div className="flex flex-col">
                        ...
                        <div className="flex flex-wrap gap-2">
                          <button className="flex items-center gap-1.5 rounded-full border border-neutral-200 px-3 py-1 text-xs text-neutral-700 transition-colors hover:bg-neutral-100 dark:border-neutral-800 dark:text-neutral-300 dark:hover:bg-neutral-800/50">
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <a
                        href="#"
                        className="text-sm font-medium text-neutral-500 transition-colors hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-neutral-50 tracking-tight"
                      >
                        Fraud Detection
                      </a>
                      <a
                    ...
                    <div className="flex flex-col">
                      ...
                      <a
                        href="#"
                        className="group relative flex h-full flex-col justify-between overflow-hidden rounded-2xl p-6 transition-all ring ring-orange-500/50"
                      >
                        ...
                        <div>
                          <Badge variant="outline" className="mb-3 border-orange-200 bg-white text-orange-600 dark:border-orange-900 dark:bg-neutral-950 dark:text-orange-400">
                            Upcoming Webinar
                          </Badge>
                          ...
                          <p className="text-sm text-neutral-600 dark:text-neutral-400 tracking-tight">
                            Join our engineers for a live teardown of the new Compute Engine architecture.
                          </p>
                        </div>
                        
                        <div className="mt-4 flex items-center text-sm font-medium text-orange-600 dark:text-orange-400">
                          Register now <ArrowUpRight className="ml-1 size-4 transition-transform group-hover:translate-x-1" />
                        </div>
                      </a>
                    </div>
                  </div>
        ...
        <div className="lg:hidden">
          <Sheet>
            ...
            <SheetContent side="right" className="w-[300px] border-l border-neutral-200 bg-white p-6 sm:w-[400px] dark:border-neutral-800 dark:bg-neutral-950 text-neutral-900 dark:text-neutral-50 flex flex-col gap-6">
              <div className="flex items-center gap-2 mb-4">
                <div className="flex h-8 w-8 items-center justify-center text-orange-600 dark:text-orange-500">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-6 w-6 fill-current">
                    <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" />
                  </svg>
                </div>
                <span className="text-lg font-bold tracking-tight text-neutral-900 dark:text-white">Watermelon</span>
              </div>

              <div className="flex flex-col gap-1">
                <a href="#" className="block py-2 text-base font-medium text-neutral-900 transition-colors hover:text-orange-600 dark:text-neutral-50 dark:hover:text-orange-400">Features</a>
                <a href="#" className="flex items-center justify-between py-2 text-base font-medium text-neutral-900 transition-colors hover:text-orange-600 dark:text-neutral-50 dark:hover:text-orange-400">
                  Developers
                  <Badge variant="secondary" className="bg-orange-100 text-orange-600 dark:bg-orange-500/20 dark:text-orange-400">API</Badge>
                </a>
                
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="solutions" className="border-none">
                    <AccordionTrigger className="justify-between py-2 text-base font-medium text-neutral-900 transition-colors hover:text-orange-600 no-underline hover:no-underline dark:text-neutral-50 dark:hover:text-orange-400">
                      Solutions
                    </AccordionTrigger>
                    <AccordionContent className="!h-auto mt-1 flex flex-col gap-3 border-l border-neutral-200 pb-0 pl-4 ml-2 dark:border-neutral-800 [&_a]:no-underline">
                      <div className="flex flex-col gap-2">
                        <span className="text-xs text-neutral-400 uppercase">Infrastructure</span>
                        <a href="#" className="text-sm font-medium text-neutral-600 hover:text-orange-600 dark:text-neutral-400 dark:hover:text-orange-400 tracking-tight">Compute Engine</a>
                        <a href="#" className="text-sm font-medium text-neutral-600 hover:text-orange-600 dark:text-neutral-400 dark:hover:text-orange-400 tracking-tight">System Status</a>
                      </div>
                      <div className="flex flex-col gap-2 mt-2">
                        <span className="text-xs text-neutral-400 uppercase">Use Cases</span>
                        <a href="#" className="text-sm font-medium text-neutral-600 hover:text-orange-600 dark:text-neutral-400 dark:hover:text-orange-400 tracking-tight">Fraud Detection</a>
                        <a href="#" className="text-sm font-medium text-neutral-600 hover:text-orange-600 dark:text-neutral-400 dark:hover:text-orange-400 tracking-tight">Predictive Analytics</a>
                        <a href="#" className="text-sm font-medium text-neutral-600 hover:text-orange-600 dark:text-neutral-400 dark:hover:text-orange-400 tracking-tight">LLM Gateways</a>
                      </div>
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>

                <a href="#" className="block py-2 text-base font-medium text-neutral-900 transition-colors hover:text-orange-600 dark:text-neutral-50 dark:hover:text-orange-400 tracking-tight">Customers</a>
                <a href="#" className="block py-2 text-base font-medium text-neutral-900 transition-colors hover:text-orange-600 dark:text-neutral-50 dark:hover:text-orange-400 tracking-tight">Enterprise</a>
              </div>

              <div className="mt-auto flex flex-col gap-3 border-t border-neutral-200 pt-6 dark:border-neutral-800">
                <Button variant="outline" className="w-full justify-center rounded-xl border-neutral-200 bg-white text-neutral-900 hover:bg-neutral-100 dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-50 dark:hover:bg-neutral-800/50">
                  Sign in
                </Button>
