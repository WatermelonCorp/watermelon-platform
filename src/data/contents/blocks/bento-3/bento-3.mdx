...
image: 'https://assets.watermelon.sh/components/watermelonoriginalassets/bento-3.webp'
video: 'https://assets.watermelon.sh/components/watermelonoriginalassets/bento-3.mp4'
featured: false
comingSoon: false
dependencies:
  - motion/react
