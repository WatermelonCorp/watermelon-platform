...
export default function Footer21({
    ...
    return (
        <footer className="relative w-full bg-[#fafafa] dark:bg-[#222222] text-neutral-800 dark:text-neutral-300 font-sans overflow-hidden transition-colors duration-300">
            ...
            <div className="mx-auto max-w-[1440px] w-full flex">
                ...
                <div className="flex-1 flex flex-col bg-[#fafafa] dark:bg-[#222222]">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 border-b border-neutral-200 dark:border-[#333]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-4 py-16 md:py-24 border-b border-neutral-200 dark:border-[#333] items-center px-4 md:px-8 lg:px-12">
                        ...
                        {/* Center Content */}
                        <div className="md:col-span-6 flex flex-col items-center text-center gap-8">
                    ...
                    <div className="flex flex-col items-center justify-center pt-10 pb-8 gap-8 px-4 md:px-8 lg:px-12">
                        ...
                        {/* Copyright */}
                        <div className="text-[12px] md:text-[13px] text-neutral-400 dark:text-neutral-500 whitespace-nowrap">
                            {copyright}
                        </div>
