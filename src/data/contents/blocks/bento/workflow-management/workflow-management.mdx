...
image: 'https://assets.watermelon.sh/components/watermelonoriginalassets/workflow-management.webp'
video: 'https://assets.watermelon.sh/components/watermelonoriginalassets/workflow-management.mp4'
featured: false
comingSoon: false
dependencies:
  - motion/react
install:
  - 'npx shadcn@latest add https://registry.watermelon.sh/r/workflow-management.json'
componentNumber: 1
---
