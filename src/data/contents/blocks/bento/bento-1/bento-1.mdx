...
image: 'https://assets.watermelon.sh/components/watermelonoriginalassets/bento-1.webp'
video: 'https://assets.watermelon.sh/components/watermelonoriginalassets/bento-1.mp4'
featured: false
comingSoon: false
dependencies:
  - motion/react
