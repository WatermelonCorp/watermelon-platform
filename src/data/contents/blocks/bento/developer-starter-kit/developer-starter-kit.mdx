...
image: 'https://assets.watermelon.sh/components/watermelonoriginalassets/developer-starter-kit.webp'
video: 'https://assets.watermelon.sh/components/watermelonoriginalassets/developer-starter-kit.mp4'
featured: false
comingSoon: false
dependencies:
  - motion/react
install:
  - 'npx shadcn@latest add https://registry.watermelon.sh/r/developer-starter-kit.json'
inspiredBy:
  name: Mintlify
