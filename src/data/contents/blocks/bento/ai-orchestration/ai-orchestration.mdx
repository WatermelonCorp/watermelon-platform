...
image: 'https://assets.watermelon.sh/components/watermelonoriginalassets/ai-orchestration.webp'
video: 'https://assets.watermelon.sh/components/watermelonoriginalassets/ai-orchestration.mp4'
featured: false
comingSoon: false
dependencies:
  - motion/react
install:
  - 'npx shadcn@latest add https://registry.watermelon.sh/r/ai-orchestration.json'
componentNumber: 1
---
