...
image: 'https://assets.watermelon.sh/components/watermelonoriginalassets/bento-7.webp'
video: 'https://assets.watermelon.sh/components/watermelonoriginalassets/bento-7.mp4'
featured: false
comingSoon: false
dependencies:
  - motion/react
