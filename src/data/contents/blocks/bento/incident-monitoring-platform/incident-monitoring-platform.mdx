...
slug: incident-monitoring-platform
category: bento
...
image: 'https://assets.watermelon.sh/components/watermelonoriginalassets/incident-monitoring-platform.webp'
video: 'https://assets.watermelon.sh/components/watermelonoriginalassets/incident-monitoring-platform.mp4'
featured: false
comingSoon: false
dependencies:
  - motion/react
  ...
  - tailwind-merge
install:
  - 'npx shadcn@latest add https://registry.watermelon.sh/r/incident-monitoring-platform.json'
inspiredBy:
  name: Better Stack
