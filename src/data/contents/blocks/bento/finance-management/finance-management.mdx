...
image: 'https://assets.watermelon.sh/components/watermelonoriginalassets/finance-management.webp'
video: 'https://assets.watermelon.sh/components/watermelonoriginalassets/finance-management.mp4'
featured: false
comingSoon: false
dependencies:
  - motion/react
  ...
  - tailwind-merge
install:
  - 'npx shadcn@latest add https://registry.watermelon.sh/r/finance-management.json'
componentNumber: 5
---
