...
image: 'https://assets.watermelon.sh/components/watermelonoriginalassets/cybersecurity-platform.webp'
video: 'https://assets.watermelon.sh/components/watermelonoriginalassets/cybersecurity-platform.mp4'
featured: false
comingSoon: false
dependencies:
  - motion/react
install:
  - 'npx shadcn@latest add https://registry.watermelon.sh/r/cybersecurity-platform.json'
inspiredBy:
  name: arvydas_gecas
