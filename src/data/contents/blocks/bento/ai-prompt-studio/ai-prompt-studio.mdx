...
image: 'https://assets.watermelon.sh/components/watermelonoriginalassets/ai-prompt-studio.webp'
video: 'https://assets.watermelon.sh/components/watermelonoriginalassets/ai-prompt-studio.mp4'
featured: false
comingSoon: false
dependencies:
  - motion/react
install:
  - 'npx shadcn@latest add https://registry.watermelon.sh/r/ai-prompt-studio.json'
inspiredBy:
  name: BentoGrids
