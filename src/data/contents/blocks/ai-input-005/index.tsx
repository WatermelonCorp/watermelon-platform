                ...
                <AnimatePresence mode="popLayout" initial={false}>
                  {(inputValue.trim() || isProcessing) && (
                    <motion.button
                      ...
                      className={`mb-1 flex items-center justify-center rounded-full p-1.5 ${isProcessing ? 'bg-neutral-900 text-neutral-100 dark:bg-neutral-800 dark:text-neutral-500' : 'bg-black text-white dark:bg-white dark:text-black'} `}
                    >
                      {isProcessing ? (
