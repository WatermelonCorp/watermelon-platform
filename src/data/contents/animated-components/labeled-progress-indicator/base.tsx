...
export const LabeledProgressIndicator: FC<LabeledProgressIndicatorProps> = ({
  ...
  return (
    <div className="theme-injected flex w-full flex-col items-center justify-center gap-8 transition-colors duration-500">
        ...
        <div className="border-border bg-muted h-4 w-[320px] overflow-hidden rounded-lg border shadow-inner">
          ...
          >
            <motion.div
              ...
              className="via-primary brightness-150 absolute inset-y-0 w-full bg-gradient-to-r from-transparent to-transparent"
            />
          </motion.div>
        </div>
      </div>
