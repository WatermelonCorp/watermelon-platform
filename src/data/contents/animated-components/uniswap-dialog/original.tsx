  ...
  return (
    <div className="relative w-max">
      ...
      <button
        ...
        className="flex items-center gap-2 rounded-full bg-gray-100 px-3 py-1.5 transition-colors hover:bg-gray-200 dark:bg-[#3A3A3A] dark:hover:bg-[#444]"
      >
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute top-[50%] left-1/2 z-999 flex h-[520px] w-[400px] -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-[28px] border border-gray-200 bg-white shadow-2xl dark:border-[#282828] dark:bg-[#181818] dark:shadow-black/50"
            >
              {/* Header */}
