...
interface BentoCardProps {
  ...
  trackType?: "bento" | "block";
}

export function BentoCard({ item, onClick, trackType = "bento" }: BentoCardProps) {
  ...
  const handleCopy = async (e: React.MouseEvent) => {
    ...
    try {
      ...
      trackEvent("install_command_copy", {
        ...
        command: cliCommand,
        source: trackType === "block" ? "block_card" : "bento_card",
      });
    } catch (err) {
  ...
  return (
    <div
      ...
      onClick={() => {
        ...
        const eventName = trackType === "block" ? "block_card_click" : "bento_card_click";
